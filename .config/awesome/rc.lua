...
vicious.register(netwidget, vicious.widgets.net, fmtstart..'NET: '..fmtend..'${wlp0s20f3 down_kb} ${wlp0s20f3 up_kb}', 2)

-- Battery status widget
batwidget = wibox.widget.textbox()
vicious.register(batwidget, vicious.widgets.bat, fmtstart..'BAT: '..fmtend..'$2 $1', 61, 'BAT0')

-- Volume status widget
volwidget = wibox.widget.textbox()
vicious.register(volwidget, vicious.widgets.volume, fmtstart..'VOL: '..fmtend..'$1 $2', 10, 'Master')
